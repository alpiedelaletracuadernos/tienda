...
const testimonials = [
  {
    name: 'Mar Chungo',
    role: 'Maestra',
    content: 'Me encantó la agenda!! Siempre satisfecha con los cuadernos que he adquirido de parte suya 🤗✨ Y súper rápido!',
    rating: 5,
  ...
  },
  {
    name: 'Agus Finelli',
    role: 'Estudiante',
    content: 'Le compre una a mi novia y le encanto, le resulto re útil! ya quiero regalarle una para el año que viene también!',
    rating: 5,
