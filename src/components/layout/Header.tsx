    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 items-center justify-between px-4">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          {/* Solo en inicio: botones con scroll interno */}
          {isHome && (
            <>
              <button
                type="button"
                onClick={() => handleScrollToSection('como-pedir')}
              ...
              <button
                type="button"
                onClick={() => handleScrollToSection('opiniones')}
                className="text-sm font-medium transition-colors hover:text-primary"
              >
                Opiniones
              </button>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-t">
          <nav className="container flex flex-col space-y-4 px-4 py-6">
            ...
            {/* Solo en inicio: botones con scroll interno en mobile */}
            {isHome && (
              <>
                <button
                  type="button"
